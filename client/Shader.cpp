...
D3D12_DEPTH_STENCIL_DESC CShader::CreateNoneDepthStencilState()
{
	D3D12_DEPTH_STENCIL_DESC d3dDepthStencilDesc;
	::ZeroMemory(&d3dDepthStencilDesc, sizeof(D3D12_DEPTH_STENCIL_DESC));
	d3dDepthStencilDesc.DepthEnable = TRUE;
...
D3D12_DEPTH_STENCIL_DESC CShader::CreateNoneMaskDepthStencilState()
{
	D3D12_DEPTH_STENCIL_DESC d3dDepthStencilDesc;
	::ZeroMemory(&d3dDepthStencilDesc, sizeof(D3D12_DEPTH_STENCIL_DESC));
	d3dDepthStencilDesc.DepthEnable = TRUE;
	...
	d3dDepthStencilDesc.FrontFace.StencilFailOp = D3D12_STENCIL_OP_KEEP;
	d3dDepthStencilDesc.FrontFace.StencilDepthFailOp = D3D12_STENCIL_OP_KEEP;
	d3dDepthStencilDesc.FrontFace.StencilPassOp = D3D12_STENCIL_OP_INVERT;
	d3dDepthStencilDesc.FrontFace.StencilFunc = D3D12_COMPARISON_FUNC_EQUAL;
	d3dDepthStencilDesc.BackFace.StencilFailOp = D3D12_STENCIL_OP_KEEP;
	d3dDepthStencilDesc.BackFace.StencilDepthFailOp = D3D12_STENCIL_OP_KEEP;
	d3dDepthStencilDesc.BackFace.StencilPassOp = D3D12_STENCIL_OP_INVERT;
	d3dDepthStencilDesc.BackFace.StencilFunc = D3D12_COMPARISON_FUNC_ALWAYS;
...
D3D12_BLEND_DESC CShader::CreateNoneAlphaBlendState()
{
	D3D12_BLEND_DESC d3dBlendDesc;
	::ZeroMemory(&d3dBlendDesc, sizeof(D3D12_BLEND_DESC));
	d3dBlendDesc.AlphaToCoverageEnable = FALSE;
...
void CShader::CreateAlphaBlendingNoneDepthShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	...
	d3dPipelineStateDesc.VS = CreateVertexShader(&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CreatePixelShader(&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateNoneDepthclipRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateAlphaBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateNoneDepthStencilState();
	d3dPipelineStateDesc.InputLayout = CreateInputLayout();
	d3dPipelineStateDesc.SampleMask = UINT_MAX;
	d3dPipelineStateDesc.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
	d3dPipelineStateDesc.NumRenderTargets = 1;
...
void CShader::CreateAlphaBlendingNoneMaskShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	...
	d3dPipelineStateDesc.RasterizerState = CreateRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateAlphaBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateNoneMaskDepthStencilState();
	d3dPipelineStateDesc.InputLayout = CreateInputLayout();
	d3dPipelineStateDesc.SampleMask = UINT_MAX;
	d3dPipelineStateDesc.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
	d3dPipelineStateDesc.NumRenderTargets = 1;
...
D3D12_RASTERIZER_DESC CShader::CreateWaterRasterizerState()
{
	D3D12_RASTERIZER_DESC d3dRasterizerDesc;
	::ZeroMemory(&d3dRasterizerDesc, sizeof(D3D12_RASTERIZER_DESC));
	d3dRasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
...
D3D12_RASTERIZER_DESC CShader::CreateNoneDepthclipRasterizerState()
{
	D3D12_RASTERIZER_DESC d3dRasterizerDesc;
	::ZeroMemory(&d3dRasterizerDesc, sizeof(D3D12_RASTERIZER_DESC));
	d3dRasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
...
void CShader::CreateAlphaBlendingWaterShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	ID3DBlob *pd3dVertexShaderBlob = NULL, *pd3dPixelShaderBlob = NULL;
	...
	d3dPipelineStateDesc.VS = CreateVertexShader(&pd3dVertexShaderBlob);
	d3dPipelineStateDesc.PS = CreatePixelShader(&pd3dPixelShaderBlob);
	d3dPipelineStateDesc.RasterizerState = CreateWaterRasterizerState();
	d3dPipelineStateDesc.BlendState = CreateWaterAlphaBlendState();
	d3dPipelineStateDesc.DepthStencilState = CreateWaterDepthStencilState();
	d3dPipelineStateDesc.InputLayout = CreateInputLayout();
	d3dPipelineStateDesc.SampleMask = UINT_MAX;
	d3dPipelineStateDesc.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE;
	d3dPipelineStateDesc.NumRenderTargets = 1;
...
D3D12_DEPTH_STENCIL_DESC CShader::CreateWaterDepthStencilState()
{
	D3D12_DEPTH_STENCIL_DESC d3dDepthStencilDesc;
	::ZeroMemory(&d3dDepthStencilDesc, sizeof(D3D12_DEPTH_STENCIL_DESC));
	d3dDepthStencilDesc.DepthEnable = TRUE;
...
D3D12_BLEND_DESC CShader::CreateWaterAlphaBlendState()
{
	D3D12_BLEND_DESC d3dBlendDesc;
	::ZeroMemory(&d3dBlendDesc, sizeof(D3D12_BLEND_DESC));
	d3dBlendDesc.AlphaToCoverageEnable = TRUE;
...
//NoneDepthshader
CNONDepthShader::CNONDepthShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC CNONDepthShader::CreateInputLayout()
{
	//UINT nInputElementDescs = 3; // 수정 5개로 
	UINT nInputElementDescs = 3;
	D3D12_INPUT_ELEMENT_DESC *pd3dInputElementDescs = new D3D12_INPUT_ELEMENT_DESC[nInputElementDescs];
...
D3D12_SHADER_BYTECODE CNONDepthShader::CreateVertexShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSNONANIMATE", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CNONDepthShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSNONANIMATE", "ps_5_1", ppd3dShaderBlob));
}

void CNONDepthShader::CreateShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState*[m_nPipelineStates];

	CShader::CreateAlphaBlendingNoneDepthShader(pd3dDevice, pd3dGraphicsRootSignature);
}
...
{
	m_nObjects = 1;
	m_xmf4x4TexTransform = Matrix4x4::Identity();
}
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSWaterTerrain", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CTerrainWaterShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSWaterTerrain", "ps_5_1", ppd3dShaderBlob));
}
...
void CTerrainWaterShader::CreateAlphaBlendingShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState*[m_nPipelineStates];
...
void CTerrainWaterShader::CreateAlphaBlendingWaterShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState*[m_nPipelineStates];

	CShader::CreateAlphaBlendingWaterShader(pd3dDevice, pd3dGraphicsRootSignature);
}
void CTerrainWaterShader::CreateShaderVariables(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	UINT ncbElementBytes = ((sizeof(CB_GAMEOBJECT_INFO) + 255) & ~255); //256의 배수
	m_pd3dcbGameObjects = ::CreateBufferResource(pd3dDevice, pd3dCommandList, NULL, ncbElementBytes * m_nObjects, D3D12_HEAP_TYPE_UPLOAD, D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, NULL);
...
void CTerrainWaterShader::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	//XMStoreFloat4x4(&m_pcbMappedGameObjects->m_xmf4x4World, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4World)));

	//08.12 texmatrix추가 
	XMFLOAT3 xmf3Offset(0.0f, 0.0f, 0.0f);
	xmf3Offset.y = 0.025f;
	xmf3Offset.x = 1;// 0.025f * sinf(2.0f * xmf3Offset.y);
					 // 행렬의 position값 x,y가 바뀌어야한다.
	m_xmf4x4TexTransform._31 += xmf3Offset.x;
	m_xmf4x4TexTransform._32 += xmf3Offset.y;
	m_xmf4x4TexTransform._11 += xmf3Offset.x;
	m_xmf4x4TexTransform._12 += xmf3Offset.x;
	m_xmf4x4TexTransform._13 += xmf3Offset.x;
	m_xmf4x4TexTransform._14 += xmf3Offset.x;
	m_xmf4x4TexTransform._21 += xmf3Offset.x;
	m_xmf4x4TexTransform._22 += xmf3Offset.x;
	m_xmf4x4TexTransform._23 += xmf3Offset.x;
	m_xmf4x4TexTransform._24 += xmf3Offset.x;
	m_xmf4x4TexTransform._33 += xmf3Offset.x;
	m_xmf4x4TexTransform._34 += xmf3Offset.x;
	m_xmf4x4TexTransform._41 += xmf3Offset.x;
	m_xmf4x4TexTransform._42 += xmf3Offset.x;
	m_xmf4x4TexTransform._43 += xmf3Offset.x;
	m_xmf4x4TexTransform._44 += xmf3Offset.x;


	//if (m_xmf4x4TexTransform._41 >= 1.0f)
	//	m_xmf4x4TexTransform._41 -= 1.0f;
	//if (m_xmf4x4TexTransform._42 >= 1.0f)
	//	m_xmf4x4TexTransform._42 -= 1.0f;

	//cout << "행렬"<<m_xmf4x4TexTransform._41;
	//cout << "행렬"<< m_xmf4x4TexTransform._42 <<endl;
	//XMStoreFloat4x4(&m_pcbMappedGameObjects->m_TexTransform, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4TexTransform)));
	//system("pause");
	D3D12_GPU_VIRTUAL_ADDRESS d3dGpuVirtualAddress = m_pd3dcbGameObjects->GetGPUVirtualAddress();
	//d3dGpuVirtualAddress = m_pcbMappedGameObjects->GetGPUVirtualAddress();
...
void CTerrainWaterShader::UpdateShaderVariables()
{
	//XMStoreFloat4x4(&m_pcbMappedGameObjects->m_xmf4x4World, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4World)));
	...
	xmf3Offset.x = 1;// 0.025f * sinf(2.0f * xmf3Offset.y);
					 // 행렬의 position값 x,y가 바뀌어야한다.
	m_xmf4x4TexTransform._41 += xmf3Offset.x;
	m_xmf4x4TexTransform._42 += xmf3Offset.y;
	...
	//cout << "행렬" << m_xmf4x4TexTransform._41;
	//cout << "행렬" << m_xmf4x4TexTransform._42;
	//XMStoreFloat4x4(&m_pcbMappedGameObjects->m_TexTransform, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4TexTransform)));
	//system("pause");
	D3D12_GPU_VIRTUAL_ADDRESS d3dGpuVirtualAddress = m_pd3dcbGameObjects->GetGPUVirtualAddress();
	//d3dGpuVirtualAddress = m_pcbMappedGameObjects->GetGPUVirtualAddress();
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VS_EFFECT", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CEffectShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PS_EFFECT", "ps_5_1", ppd3dShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VS_Shadow", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CShadowShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PS_Shadow", "ps_5_1", ppd3dShaderBlob));
}
...
void CShadowShader::CreateShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	...
	CShader::CreateAlphaBlendingNoneMaskShader(pd3dDevice, pd3dGraphicsRootSignature);
}
//void CShadowShader::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
//{
//	UINT ncbElementBytes = ((sizeof(CB_GAMEOBJECT_INFO) + 255) & ~255);
...
//	{
//		CB_GAMEOBJECT_INFO *pbMappedcbGameObject = (CB_GAMEOBJECT_INFO *)((UINT8 *)m_pcbMappedGameObjects + (j * ncbElementBytes));
//		XMStoreFloat4x4(&pbMappedcbGameObject->m_xmf4x4World, XMMatrixTranspose(XMLoadFloat4x4(&m_ppObjects[j]->m_xmf4x4World)*S * shadowOffsetY));
//#ifdef _WITH_BATCH_MATERIAL
//		if (m_pMaterial) pbMappedcbGameObject->m_nMaterial = m_pMaterial->m_nReflection;
//#endif
//	}
//
//}
//void CShadowShader::CreateShaderVariables(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
//{
//	UINT ncbElementBytes = ((sizeof(CB_GAMEOBJECT_INFO) + 255) & ~255); //256의 배수
//	m_pd3dcbGameObjects = ::CreateBufferResource(pd3dDevice, pd3dCommandList, NULL, ncbElementBytes * m_nObjects, D3D12_HEAP_TYPE_UPLOAD, D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, NULL);
//
...
CNONAnimateShadowShader::CNONAnimateShadowShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC CNONAnimateShadowShader::CreateInputLayout()
{
	//UINT nInputElementDescs = 3; // 수정 5개로 
	UINT nInputElementDescs = 3;
	D3D12_INPUT_ELEMENT_DESC *pd3dInputElementDescs = new D3D12_INPUT_ELEMENT_DESC[nInputElementDescs];
...
D3D12_SHADER_BYTECODE CNONAnimateShadowShader::CreateVertexShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSNONANIMATESHADOW", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CNONAnimateShadowShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSNONANIMATESHADOW", "ps_5_1", ppd3dShaderBlob));
}

void CNONAnimateShadowShader::CreateShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState*[m_nPipelineStates];
