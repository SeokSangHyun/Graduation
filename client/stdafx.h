...
#define ANIFRAMETIME			0.0333333f // 추가코드 04.10
#define GetFBXMesh				GetGameObject(0)->GetMesh(0) //추가 코드 04.28
...
#define RANDOM_NORMALFLOAT3 XMFLOAT3(float(rand() % 2), float(rand() % 2), float(rand() % 2))
#define RED_COLOR XMFLOAT4(rand() %20 , rand()  / float(RAND_MAX), rand() / float(RAND_MAX), rand()  / float(RAND_MAX))

#define BLUE_COLOR XMFLOAT4(rand()  / float(RAND_MAX) , rand()  %20, rand() / float(RAND_MAX), rand()  / float(RAND_MAX))

#define GREEN_COLOR XMFLOAT4(rand()  / float(RAND_MAX) , rand()/ float(RAND_MAX) , rand()%20, rand()  / float(RAND_MAX))
